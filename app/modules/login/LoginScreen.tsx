...
import { ActivityLoader, AppText, CustomButton, CustomSwitch, CustomTextInput } from '../../components';
    ...
    <SafeAreaView style={styles.rootContainerStyle}>
      ...
      <ScrollView
        ...
        <View style={styles.horizontalViewStyle}>
          <AppText style={styles.rememberUsrTextStyle}>{loginScreenStrings.rememberUserName}</AppText>
          <CustomSwitch
        ...
        <View style={styles.horizontalViewStyle}>
          <AppText style={styles.rememberUsrTextStyle}>{loginScreenStrings.enableFingerprint}</AppText>
          <CustomSwitch value={enableFaceId} onValueChange={setEnableFaceId} inActiveColor={Colors.lightSlateGray} />
        </View>
        <CustomButton
